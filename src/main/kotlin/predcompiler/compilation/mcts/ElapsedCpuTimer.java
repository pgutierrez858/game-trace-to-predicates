...
/**
 * CPU Timer implementation from <a
 * href="https://github.com/GAIGResearch/TabletopGames/blob/master/src/main/java/utilities/ElapsedCpuTimer
 * .java#L11">TAG's Utilities Implementation</a>.
 */
public class ElapsedCpuTimer {
    ...
    protected long getCpuTime() {
        if (OS_WIN) return System.nanoTime();
